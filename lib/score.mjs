...
export const WEIGHTS = {
  // Direct beats adjacent beats genre. Within a name tier, a name matched exactly
  // beats one matched as a phrase inside a longer title, because the second is a
  // less certain read.
  //
  // Genre sits deliberately below both name tiers. "This is R&B" is a far weaker
  // claim than "this is an artist you named", and the card labels it as a genre
  // match so it is never presented as taste.
  taste: { max: 45, direct: 45, directLoose: 40, adjacent: 20, adjacentLoose: 17, genre: 12 },
